...
class G4MOSSNuclearLevel {
 public:
  G4MOSSNuclearLevel(const G4int nLevel, const G4int nucleusZ, const G4int nucleusA,
  ...
  G4bool operator==(const G4MOSSNuclearLevel &right) const;
  G4bool operator!=(const G4MOSSNuclearLevel &right) const;
  G4bool operator<(const G4MOSSNuclearLevel &right) const;

  const G4MOSSNuclearLevel& operator=(const G4MOSSNuclearLevel &right) {
    if (this != &right) {
  ...
  G4MOSSNuclearLevel(const G4MOSSNuclearLevel &right) {
    if (this != &right) *this = right;
  }

 private:
  G4MOSSNuclearLevel() {G4cout << "Calling default constructor" << G4endl;}
