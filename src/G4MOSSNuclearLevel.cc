...
// Description:
//
// G4MOSSNuclearLevel is the class used to instantiate a particular level of a
// particular nucleus; its members include the energy, spin, etc of the level.
// To build the levels, data is imported using the G4MOSSNuclearLevelManager
...
//    G4MOSSNuclearLevel, we can mark the level as invalid, then in
//    G4MOSSNuclearLevelManager, we use the function delete_bad_spins() to erase
//    such levels in their entirety.
//
// 5) Addition of standalone NRF gamma database generation. See PrintAllTabular()
//    or the G4MOSS.cc source file.
//
// -------------------------------------------------------------------
...
G4int G4MOSSNuclearLevel::Increment(G4int aF) {
  static G4int instanceCount = 0;
  instanceCount += aF;
  return instanceCount;
}

G4MOSSNuclearLevel::G4MOSSNuclearLevel(const G4int nLevel,
...
G4MOSSNuclearLevel::~G4MOSSNuclearLevel()
{;}


G4bool G4MOSSNuclearLevel::operator==(const G4MOSSNuclearLevel &right) const {
  return (this == (G4MOSSNuclearLevel *) &right);
}
...
const std::vector<double>& G4MOSSNuclearLevel::GammaEnergies() const {
  return _energies;
}

const std::vector<double>& G4MOSSNuclearLevel::GammaWeights() const {
  return _weights;
}

const std::vector<double>& G4MOSSNuclearLevel::GammaProbabilities() const {
  return _prob;
}

const std::vector<double>& G4MOSSNuclearLevel::GammaCumulativeProbabilities() const {
  return _cumProb;
}

const std::vector<double>& G4MOSSNuclearLevel::GammaPolarities() const {
  return _polarities;
}

const std::vector<double>& G4MOSSNuclearLevel::KConvertionProbabilities() const {
  return _kCC;
}

const std::vector<double>& G4MOSSNuclearLevel::L1ConvertionProbabilities() const {
  return _l1CC;
}

const std::vector<double>& G4MOSSNuclearLevel::L2ConvertionProbabilities() const {
  return _l2CC;
}

const std::vector<double>& G4MOSSNuclearLevel::L3ConvertionProbabilities() const {
  return _l3CC;
}

const std::vector<double>& G4MOSSNuclearLevel::M1ConvertionProbabilities() const {
  return _m1CC;
}

const std::vector<double>& G4MOSSNuclearLevel::M2ConvertionProbabilities() const {
  return _m2CC;
}

const std::vector<double>& G4MOSSNuclearLevel::M3ConvertionProbabilities() const {
  return _m3CC;
}

const std::vector<double>& G4MOSSNuclearLevel::M4ConvertionProbabilities() const {
  return _m4CC;
}

const std::vector<double>& G4MOSSNuclearLevel::M5ConvertionProbabilities() const {
  return _m5CC;
}

const std::vector<double>& G4MOSSNuclearLevel::NPlusConvertionProbabilities() const {
  return _nPlusCC;
}

const std::vector<double>& G4MOSSNuclearLevel::TotalConvertionProbabilities() const {
  return _totalCC;
}

const std::vector<int>& G4MOSSNuclearLevel::MultipoleNumModes() const {
  return _Num_multipole;
}

const std::vector<char>& G4MOSSNuclearLevel::MultipoleMode1() const {
  return _Multipole_mode1;
}

const std::vector<int>& G4MOSSNuclearLevel::MultipoleL1() const {
  return _Multipole_L1;
}

const std::vector<char>& G4MOSSNuclearLevel::MultipoleMode2() const {
  return _Multipole_mode2;
}

const std::vector<int>& G4MOSSNuclearLevel::MultipoleL2() const {
  return _Multipole_L2;
}

const std::vector<double>& G4MOSSNuclearLevel::MultipoleMixingRatio() const {
  return _Multipole_mixing_ratio;
}

const std::vector<int>& G4MOSSNuclearLevel::MultipoleMixRatioSignFlag() const {
  return _Multipole_mixing_sign_flag;
}

G4int G4MOSSNuclearLevel::nLevel() const {
  return _nLevel;
}

G4int G4MOSSNuclearLevel::Z() const {
  return _nucleusZ;
}

G4int G4MOSSNuclearLevel::A() const {
  return _nucleusA;
}

G4double G4MOSSNuclearLevel::AngularMomentum() const {
  return _angularMomentum;
}

G4double G4MOSSNuclearLevel::Parity() const {
  return _parity;
}

G4double G4MOSSNuclearLevel::HalfLife() const {
  return _halfLife;
}

G4int G4MOSSNuclearLevel::NumberOfGammas() const {
  return _nGammas;
}

G4double G4MOSSNuclearLevel::Width() const {
  return _Tau;
}

G4double G4MOSSNuclearLevel::Width0() const {
  return _Tau0;
}

G4double G4MOSSNuclearLevel::MaxGammaEnergy() const {
  if (_nGammas > 0)
...
G4bool G4MOSSNuclearLevel::GetInvalidLevel() {
  return invalidLevel;
}

void G4MOSSNuclearLevel::SetInvalidLevel() {
  invalidLevel = true;
}

G4double G4MOSSNuclearLevel::SelectGamma(G4int& igamma) const {
  ...
  if (_nGammas > 0) {
    if ((_nGammas == 1) && (_weights[0] == 0.0)) {
      ...
      //G4cout << "the conversion ratio is " << tot_cc <<G4endl;
...
void G4MOSSNuclearLevel::PrintAll() const {
...
void G4MOSSNuclearLevel::PrintAllTabular(ofstream& file, double gsSpin, double TDebye) const {
...
G4double G4MOSSNuclearLevel::GetGSProb() const {
  double GSprob = 0.0;
  for (int i = 0; i < _nGammas; ++i) {
...
void G4MOSSNuclearLevel::MakeProbabilities() {
  G4double sum = 0.;
  G4int i = 0;
...
void G4MOSSNuclearLevel::MakeCumProb() {
  if (_nGammas > 0) {
...
void G4MOSSNuclearLevel::RefreshGammas() {
  ...
  if (!env) {
    G4cout << "G4MOSSNuclearLevel: please set the G4MOSSGAMMADATA environment variable" << G4endl;
  ...
  if (_Verbose) {
    G4cout << "**************************** In G4MOSSNuclearLevel::RefreshGammas()." << G4endl;
  ...
  if (!GammaTableFile) {
    G4cout << "Error in G4MOSSNuclearLevel::RefreshGammas()" << G4endl;
  ...
  if (_Verbose) {
    G4cout << "G4MOSSNuclearLevel::RefreshGammas -- " << G4endl;
...
void G4MOSSNuclearLevel::RefreshWidth() {
  // NRF-specific routine
  //
...
void G4MOSSNuclearLevel::MakeWidth0() {
  // NRF-specific routine
  //
...
void G4MOSSNuclearLevel::Calc_Tau0() {
  // NRF-specific routine
  //
  ...
  if (_nGammas > 0) {
    ...
    if (gamma_to_gs) {
      ...
      if (_Verbose) {
        G4cout << "G4MOSSNuclearLevel::Calc_Tau0(): Calculated _Tau0 (eV) = "
               << _Tau0/eV << G4endl;
...
G4bool G4MOSSNuclearLevel::Identify_GS_Transition() {
  // NRF-specific routine
  //
  ...
  // Nuclear recoil energy (non-relativistic approx.); see G4MOSS class for factor of 2 explanation
...
const interpolating_function_p<G4double>* G4MOSSNuclearLevel::GetCrossSectionTable() const {return _cross_sec_interp_func;}

void G4MOSSNuclearLevel::SetCrossSectionTable(interpolating_function_p<G4double> *f) {_cross_sec_interp_func = f;}
