...
//
/// \file BMSLayer1SD.cc
/// \brief Implementation of the BMSLayer1 class
...
BMSLayer1SD::BMSLayer1SD(G4String name)
...
BMSLayer1SD::~BMSLayer1SD()
{}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void BMSLayer1SD::Initialize(G4HCofThisEvent* hce)
{
  fHitsCollection 
    = new BMSLayer1HitsCollection(SensitiveDetectorName,collectionName[0]);
...
G4bool BMSLayer1SD::ProcessHits(G4Step* step, G4TouchableHistory*)
{
